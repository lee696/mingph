                ...
                <li>
                    ...
                    <div class="r_side v_code">
                        ...
                        <input type="text" class="msgVcode" name="vCode" required="true" maxlength='6'
                               required="true" validate="/^[\d]+$/" msg="请正确填写验证码" >
                        <!--   <i><img src="/static/images/success.png"/></i> -->
                        <div style="background: #ebebe4;">发送验证码</div>
                    </div>
                </li>
        ...
        <div class="more_info">
            ...
            <div class="upload_info">
                ...
                <div class="uplod_items">
                    ...
                    <div class="photo_box">
                        <div style="background: #ebebe4;" id="addZpic" class="addpic">
                            <img src="/static/images/add1.png"/>
                        </div>
                ...
                <div class="uplod_items">
                    ...
                    <div class="photo_box clear">
                        ...
                        <div id="identadd1" style="float: left;margin-right: 10px" class="addpic">
                            <img src="/static/images/add1.png"/>
                        </div>
                    </div>
                </div>
...
<script src="/static/js/iecheck.js?v=0.01"></script>
    ...
    <script>
        var subinf = '<?php echo U("User/join-submit");?>';
    </script>
    <script src="/static/js/join-submit-readonly.js"></script>
