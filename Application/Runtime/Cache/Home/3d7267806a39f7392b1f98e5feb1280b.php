            ...
            <div class="flex main justify-center align-center">
               <!-- <div class="flex order-info direction-col space-between align-start">
                ...
                <div class="code-box flex direction-col justify-center align-center">
                    <div id="wechatQrbox" class="qr-code flex justify-center align-center">
                      <!--  <img src="/static/images/test/code.png" />-->
                    </div>
                    <p>使用微信【扫一扫】上方二维码进行支付</p>
                </div>
            </div>
            <a class="finish-wx-pay bold-font gold-font" id="scomplete" href="<?php echo U('User/wallet');?>">完成支付</a>
        </div>
    </div>
...
<script src="/static/js/iecheck.js?v=0.01"></script>
    ...
    <script src="/static/js/wxChargePay.js?v=0.01"></script>
