...
<nav class="navigator">
    ...
    <div class="main-width help clear">
        <nav class="help-sidebar">
            <div class="sidebar-title">
                <h3>帮助中心</h3>
            </div>
            <div class="module help-list"></div>
        </nav>
        <div class="help-main">
            <div class="sidebar-title">
                <h3>首页 > 帮助中心 > <span class="ttt"></span></h3>
            </div>
            <div class="content">
                <h2 class="title"></h2>
                <div class="desc"></div>
...
<script src="/static/js/iecheck.js?v=0.01"></script>
    ...
    <script src="/static/js/pagination.min.js?v=0.01"></script>
    <script src="/static/js/help.js?v=0.01"></script>
